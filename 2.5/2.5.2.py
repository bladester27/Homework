...
class MyList(object):
    ...
    # def add_random_place(self, arg):
    #     self.Mylist.insert(rd.randint(0, (len(MyList) - 1), arg))

    def delete_end_element(self):
        self.__getitem__(len(self) - 1)

    # def delete_random(self):
    #     self.MyList.pop(rd.randint(0, (len(MyList) - 1)))

def main():
    # Создание списка
    my_list = MyList([1, 2, 5])
    my_list.delete_end_element()
    # Вывод длины списка
    #print(len(my_list))
...
if __name__ == '__main__':
    ...
    # print(my_list)
    # my_list.clear()
    # my_list.add_random_place(10)
    # print(my_list)
    # my_list.add_random_place(15)
    # print(my_list)
    # my_list.delete_element()
    # print(my_list)
    # my_list.delete_random()
    # print(my_list)
    # my_list.delete_element()
